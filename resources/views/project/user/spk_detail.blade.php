            ...
            <div class="card-body">
               <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{ $spk->tender->rab->workorder->budget_tahunan->kawasan->name or '' }}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>{{ $spk->tender->rab->workorder->detail_pekerjaan->first()->itempekerjaan->parent->name or ''}}</td>
                  </tr>
                  <tr>
          ...
          <div class="card">
            ...
            <div class="card-body">
               <table id="example1" class="table table-bordered table-striped annwijin">
                  ...
                  <tr>
                    <td style="background-color: grey;color:white;"><strong>Klarifikasi 2</strong></td>
                    <td>{{ $spk->tender->klarifikasi2_date->format('d M Y')}}</td>
                  </tr>
                  <tr>
                    <td style="background-color: grey;color:white;"><strong>Klarifikasi 3</strong></td>
                    <td>{{ $spk->tender->penawaran3_date->format('d M Y')}}</td>
                  </tr>
                </table><br>      
            </div>
            <!-- /.card-body -->
