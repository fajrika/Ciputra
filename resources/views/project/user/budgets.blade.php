          ...
          <div class="card">
            ...
            <div class="card-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr>
                    <td colspan="2"><strong><span style="font-size: 14px;"><strong>TOTAL BUDGET DEVELOPMENT COST</strong></span></strong></td>
                    <td style="text-align: right;"><strong>Rp. {{ number_format($budget->total_dev_cost)}}</strong></td>
                  </tr>
                  <!--tr>
                    <td colspan="2"><strong><span style="font-size: 14px;">TOTAL BUDGET CONSTRUCTION COST</span></strong></td>
