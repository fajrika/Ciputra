          ...
          <div class="card">
            ...
            <div class="card-body col-md-4">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{ number_format($workorder->estimasi_nilaiwo + $devcost) }}</td>
                </tr>
              </table><br>
            </div>
            <div class="card-body col-md-12">
              @php $nilai = 0 @endphp
                  ...
                  @endfor
              <h4>Development Cost ( Subtotal :  Rp. {{ number_format($nilai) }}) </h4>
              ...
              <br>
               @php $nilai = 0 @endphp
                ...
                @php $nilai = $value2->asset->templatepekerjaan->con_cost + $nilai @endphp
                @endforeach
              <h4>Construction Cost ( Subtotal :  Rp. {{ number_format($nilai) }})</h4>
              <table id="example3" class="table table-bordered">
                <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $value2->asset->type->name }}</td>
                    <td>{{ number_format($value2->asset->templatepekerjaan->con_cost) }}</td>                    
                  </tr>
                  @php $nilai = $value2->asset->templatepekerjaan->con_cost + $nilai @endphp
                  @endforeach
                  <tr>
                    <td colspan="3" style="background-color: grey;color:white;"><i>Total(Rp)</i></td>
                    <td><i>{{ number_format($nilai) }}</i></td>
                  </tr>
                </tbody>
              </table>
            </div>
