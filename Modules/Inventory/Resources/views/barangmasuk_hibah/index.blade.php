...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<a href="{{ url('/inventory/barangmasuk_hibah/printReport') }}" class="btn btn-primary"><i class="fa fa-print"></i> Cetak</a>
	<br/>
		...
		gentable = $('#table_data').DataTable(
		{
          ...
          columns:[
				 ...
				 { data: 'selisih',name: 'selisih',render:fnSelisih,"className":"text-center","bSortable": false},
                {
                  ...
                  "<button class='listreject btn btn-warning btn-xs' rel='tooltip' data-toggle='tooltip' data-placement='top' title='Detail Tolak'><i class='fa fa-times-circle-o'></i></button>" +
                  "<button class='print btn btn-primary btn-xs' rel='tooltip' data-toggle='tooltip' data-placement='top' title='Cetakan'><i class='fa fa-print'></i></button>" +
