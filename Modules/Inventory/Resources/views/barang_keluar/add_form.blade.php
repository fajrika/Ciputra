          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="col-md-12">
				...
				<input type="hidden" name="url_post" id="url_post" value="" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		tBody.on('click','.btn-save',function(){
			...
			{
				alertify.danger('silahkan pilih gudang');
			}
			...
			if($(this).is(':checked'))
			{
				...
				{
					var _url = "{!! url('/barang_keluar_detail/create') !!}";
					var objSend = [];
				...
				{
					alertify.danger('Kuantiti salah');
