    ...
    <table width="100%" align="center" class="tg1">
      <thead>
        ...
        <tr>
          ...
          <td>: {{ $barangkeluar->permintaanbarang->no }}</td>
        </tr>
        <tr>
          <td>Department</td>
          <td>: {{ $barangkeluar->permintaanbarang->department->name }}</td>
        </tr>
        
        <tr>
          <td>Project</td>
          <td>: {{ $barangkeluar->permintaanbarang->project->name }}</td>
        </tr>
        <tr>
          <td>Pt</td>
          <td>: {{ $barangkeluar->permintaanbarang->pt->name }}</td>
        </tr>
        <tr>
          <td>SPK</td>
          <td>: {{ $barangkeluar->permintaanbarang->spk->no or '-' }}</td>
        ...
        <thead style="background: #3FD5C0;">
          ...
          @foreach($barangkeluardetails as $key =>$value)
            <tr>
              ...
              <td class="center-text">{{ $value->item->name }}</td>
