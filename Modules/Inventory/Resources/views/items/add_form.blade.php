            ...
            <div class="box-body">
              <div class="col-md-12">
              	...
              	@include('form.a',[
					...
					<hr/>
<form method="post" id="id-SaveForm" action="{{ url('/inventoryitems/create') }}" autocomplete="off" class="form-horizontal form-label-left">
	{{ csrf_field() }}
		<div class="item form-group">
		  	...
		  	<div class="item form-group">
			    <label class="control-label col-md-3 col-sm-3 col-xs-12">Brand / Merek</label>
			    <div class="col-md-7 col-sm-7 col-xs-12">
