...
<script type="text/javascript" charset="utf-8">
	...
	$(document).ready(function() {
		...
		gentable = $('#table_data').DataTable(
		{
        	...
        	"columns":[
                  	...
                  	{ data: 'satuan',name:'satuan',"bSortable": false},
	                {
	                  ...
	                  " <button class='price btn btn-primary btn-xs' rel='tooltip' data-toggle='tooltip' data-placement='top' title='Prices'><i class='fa fa-dollar'></i></button>"+
		...
		sbody.on('click','.btn-detail-items',function()
		{
			...
			window.location.href="{{ url('/inventory/items/details/') }}/"+data.id;
		}).
			...
			$.confirm({
				...
				buttons: {
					deleteUser: {
						...
						action: function () {
							window.location.href='{{ url("/ivnentory/items/edit_form") }}'+'?id='+edit_id;
						}
					},
