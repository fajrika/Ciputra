    ...
    gentable = $('#table_master').DataTable({
          ...
          "drawCallback": function ( settings ) {
            ...
            api.column(0, {page:'current'} ).data().each( function ( group, i ) {
              if ( last !== group ) {
                  $(rows).eq( i ).before(
                      '<tr class="group success" rowspan="2"><td colspan="6"><strong>'+group+'</strong></td><td><button class="approve btn btn-info btn-xs" rel="tooltip" data-toggle="tooltip" data-placement="left" title="Approve"><i class="fa fa-check-square"></i></button> </td></tr>'
                  );
