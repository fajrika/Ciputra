...
<form action="{{ url('/inventory/pengembalian_barang/store') }}" method="post" class="form-horizontal form-label-left" id="form_master">
	...
	<div class="form-group">
		<div class="col-md-6 col-md-offset-3">
			<button id="send" type="submit" disabled="disabled" class="btn btn-success">Save</button>
			<button id="hide" type="reset" class="btn btn-success">Cancel</button>
		</div>
	</div>
...
<!--table -->
<table id="datatable_permintaan" class="table table-striped table-bordered table-hover table-responsive table-checkable order-column nowrap">
	<thead>
		<tr>
			<th>#</th>
