...
class PermintaanBarangController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        return view('permintaan_barang.edit_form', compact('projectname','permintaan', 'projects', 'pts', 'departments', 'spks', 'users','statusPermintaans'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $permintaans->department_id             = $request->department_id;
        $permintaans->spk_id                    = $request->spk_id;
        $permintaans->user_id                   = $request->user_id;
        $permintaans->status_permintaan_id      = $request->status;
        $permintaans->date                      = $request->date;
        $permintaans->description               = $request->description;
        $status                                 = $permintaans->save();
    ...
    public function print(Request $request)
    {
       ...
       // $details = 
        ...
        $pdf = PDF::loadView('permintaan_barang.print',compact('permintaan'))->setPaper('a4','potrait');
    ...
    public function approvePermintaanBarang(Request $request)
    {
        ...
        $documentType = 'App\Permintaanbarang';
        $user_id = Auth::user()->id;
