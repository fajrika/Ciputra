...
class BarangKeluarController extends Controller
{
    ...
    public function getDataBarangKeluar($id)
    {
        ...
        ->join(DB::raw("((
            ...
            pds.item_satuan_id,
            inv.warehouse_id,
             (select konversi from item_satuans where id = pds.item_satuan_id) as nilai_konversi_permintaan,
    ...
    public function addPost(Request $request)
    {
        ...
        $execute = Barangkeluar::create([
                ...
                'date' => $date,
                'no' => CreateDocument::createDocumentNumber('BK',$department_id,session('project'),Auth::user()->id)
            ]);
        if($execute)
        {
            $stat = true;
    ...
    public function print(Request $request)
    {
        ...
        $pdf = PDF::loadView('barang_keluar.print',compact('barangkeluar','barangkeluardetails'))->setPaper('a4','potrait');
