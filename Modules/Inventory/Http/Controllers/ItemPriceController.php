...
class ItemPriceController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        return view('inventory::items_price.edit_form', compact('items_prices', 'satuans'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $items_price->price             = $request->mprice;
        $items_price->date_price       = $request->date;
        /*$items_price->price_kecil       = $request->price_kecil;
        $items_price->price_besar       = $request->price_besar;
        $items_price->matauang          = $request->matauang;
        $items_price->kurs              = $request->kurs;
        $items_price->volume            = $request->volume;*/
        $items_price->description       = $request->description;
        $status                         = $items_price->save();
        ...
        return response()->json(['stat'=>$stat,'id'=>$request->item_id]);
