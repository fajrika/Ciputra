...
class WarehouseController extends Controller
{
    ...
    public function addPost(RequestWarehouse $request)
    {
        ...
        $warehouses->project_id                             = session('project');
    ...
    public function edit(Request $request)
    {
        ...
        return view('inventory::warehouse.edit_form', compact('warehouses', 'cities'));
    }
    ...
    {
        $stat = false;
        $warehouses                                 = \App\Warehouse::find($request->id);
    ...
    public function details($id)
    {
        ...
        return view('inventory::warehouse.details',compact('warehouse'));
    }
